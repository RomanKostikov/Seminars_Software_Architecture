...
public class CustomersApiController implements CustomersApi {
    ...
    public ResponseEntity<Customer> deleteUserById(@Parameter(in = ParameterIn.PATH, description = "Идентификатор пользователя", required=true, schema=@Schema()) @PathVariable("customer_id") String customerId) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<Customer>(objectMapper.readValue("{\n  \"password\" : \"оченьмноготекстасциферками\",\n  \"balance\" : \"1 000 000 $\",\n  \"phone\" : \"880077777\",\n  \"name\" : \"YouJhin\",\n  \"id\" : \"135\",\n  \"login\" : \"qwerty\",\n  \"email\" : \"user@mail.com\"\n}", Customer.class), HttpStatus.NOT_IMPLEMENTED);
            } catch (IOException e) {
